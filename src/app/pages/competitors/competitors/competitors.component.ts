...
const competitor: Competitor[] = [
    {id: 1, name: 'Hydrogen', surname: 'Wasilewska', nickname: 'xaf', weight: 75, team: 'H', belt: 'black'},
    ...
    {id: 5, name: 'Boron', surname: 'Sikorski', nickname: 'fgh', weight: 90, team: 'B', belt: 'black'},
    {id: 6, name: 'Carbon', surname: 'Kwiatkowska', nickname: 'fgh', weight: 50, team: 'C', belt: 'purple'},
    {id: 7, name: 'Nitrogen', surname: 'Włodarczyk', nickname: 'dfg', weight: 78, team: 'N', belt: 'black'},
    {id: 8, name: 'Oxygen', surname: 'Wilk', nickname: 'dfgdf', weight: 78, team: 'O', belt: 'black'},
    {id: 9, name: 'Fluorine', surname: 'Wieczorek', nickname: 'dfgdf', weight: 66, team: 'F', belt: 'black'},
    {id: 10, name: 'Edward', surname: 'Włodarczyk', nickname: 'dfgdf', weight: 60, team: 'Ne', belt: 'black'},
    {id: 11, name: 'Romeo', surname: 'Sikora', nickname: 'gdfg', weight: 70, team: 'Ne', belt: 'purple'},
    {id: 12, name: 'Alastair', surname: 'Dudek', nickname: 'dfgdf', weight: 90, team: 'Ne', belt: 'black'},
    ...
    {id: 16, name: 'Wilfred', surname: 'Kaźmierczak', nickname: 'dfg', weight: 88, team: 'Ne', belt: 'black'},
    {id: 17, name: 'Calvin', surname: 'Jakubowski', nickname: 'asdf', weight: 80, team: 'Ne', belt: 'black'},
    {id: 18, name: 'Mohamad', surname: 'Ziółkowski', nickname: 'bdf', weight: 66, team: 'Ne', belt: 'brown'},
    {id: 19, name: 'Omari', surname: 'Kołodziej', nickname: 'dfv', weight: 87, team: 'Ne', belt: 'black'},
